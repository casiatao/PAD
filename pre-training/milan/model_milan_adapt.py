...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
                 ...
                 mlp_ratio=4., norm_layer=nn.LayerNorm, norm_pix_loss=False, use_clip=False, attn_mask=False,
                 adapt=False, down_size=64, adapt_scalar="0.5", init_value="0.5", layernorm_option="in",
                 patch_wise_scalar=False, fusion_method="concat"):
        super().__init__()
        ...
        self.blocks = nn.ModuleList([
            Block(embed_dim, num_heads, mlp_ratio, qkv_bias=True, qk_scale=None, norm_layer=norm_layer,
                  adapt=adapt, down_size=down_size, adapt_scalar=adapt_scalar, init_value=init_value, layernorm_option=layernorm_option,
    ...
    def forward_loss(self, imgs, pred, mask, clip_teacher=None, cluster_result=None):
        if self.use_clip is False:
            """
            imgs: [N, 3, H, W]
            pred: [N, L, p*p*3]
    ...
    def forward(self, imgs, mask_ratio=0.75, clip_teacher=None, cluster_result=None):
        if self.use_clip:
        ...
        loss = self.forward_loss(imgs, pred, mask, clip_teacher, cluster_result)
        return loss, pred, mask


def milan_vit_base_patch16_dec512d8b(**kwargs):
...
def milan_vit_large_patch16_dec512d8b(**kwargs):
    model = MaskedAutoencoderViT(
...
def milan_vit_huge_patch14_dec512d8b(**kwargs):
    model = MaskedAutoencoderViT(
...
def milan_vit_small_patch16_dec512d8b(**kwargs):
    model = MaskedAutoencoderViT(
...
milan_vit_base_patch16 = milan_vit_base_patch16_dec512d8b  # decoder: 512 dim, 8 blocks
milan_vit_large_patch16 = milan_vit_large_patch16_dec512d8b  # decoder: 512 dim, 8 blocks
milan_vit_huge_patch14 = milan_vit_huge_patch14_dec512d8b  # decoder: 512 dim, 8 blocks
milan_vit_small_patch16 = milan_vit_small_patch16_dec512d8b  # decoder: 512 dim, 8 blocks
