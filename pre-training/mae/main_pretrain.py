...
import models_mae
# import models_mae_residual_scalar
...
def get_args_parser():
    parser = argparse.ArgumentParser('PAD pre-training', add_help=False)
    ...
    parser.add_argument('--ratio_p', default=0.85, type=float)
    
    parser.add_argument('--scale_epoch', default=0.6, type=float)
    parser.add_argument('--layerdecay_scale', default=0, type=int)
    return parser
...
def main(args):
    ...
    model = models_mae.__dict__[args.model](norm_pix_loss=args.norm_pix_loss, 
                                                 ...
                                                 layerdecay_scale=args.layerdecay_scale) 
    ...
    #mark following timm: set wd as 0 for bias and norm layers
